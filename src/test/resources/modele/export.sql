...
CREATE TABLE PRODUCT (
	...
	QUANTITY_ON_HAND INTEGER CONSTRAINT FK_QUANTITY_STOCK_POSITIVE CHECK (QUANTITY_ON_HAND >= 0.0),
	MARKUP DECIMAL(4,2),
	AVAILABLE VARCHAR(5),
...
CREATE TABLE PURCHASE_ORDER (
	...
	CUSTOMER_ID INTEGER NOT NULL,
	PRODUCT_ID INTEGER NOT NULL,
	QUANTITY SMALLINT CONSTRAINT FK_QUANTITY_POSITIVE CHECK (QUANTITY >= 0.0),
